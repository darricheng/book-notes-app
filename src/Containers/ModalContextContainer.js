    ...
    <ConfirmationModalContext.Provider value={{ showConfirmation: handleShow }}>
      ...
      {showConfirmationModal && (
        <div
          id="popup-modal"
          tabIndex="-1"
          className="flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full justify-center items-center bg-gray-500 bg-opacity-70"
          aria-hidden="true"
        >
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-6 text-center">
                ...
                <button
                  data-modal-toggle="popup-modal"
                  type="button"
                  className="ml-2 text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
                  onClick={handleOk}
                >
                  Yes, I'm sure
                </button>
